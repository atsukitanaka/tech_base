...
<body>
    <p>この掲示板のテーマ「今日の起床時間」</p>
    <form action="" method="post" >
        【投稿フォーム】<br>
        name:<input type="text" name="name" value=<?php if(isset($E_name)){echo $E_name;} ?> > <br>
        comment:<input type="text" name="comment" value=<?php if(isset($E_comment)){echo $E_comment;} ?> > <br>
        password:<input type="text" name="pass" value=<?php if(isset($E_name)){echo $E_pass;}?>> <br>
